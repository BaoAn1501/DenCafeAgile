...
import com.antbps15545.dencafeagile.chat.MessageActivity;
...
public class UserListChatAdapter extends RecyclerView.Adapter<UserListChatAdapter.ViewHolder> {
    Context context;
    List<User> list = new ArrayList<>();
    public UserListChatAdapter(Context context, List<User> list) {
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, MessageActivity.class).putExtra("from", 2).putExtra("userid", user.getUserId()));
            }
        });
    }
